...
async function loadData(forceReload = false) {
    try {
        ...
        if (cache) {
            ...
            console.log(`Cache ausente, expirado o forzado. Consultando Supabase para el año ${YEAR}...`);
            // Obtenemos todos los registros del año de una sola vez
            const [ingresos, egresos] = await Promise.all([
                fetchAllFromTable('ingresos-anno', YEAR),
                fetchAllFromTable('egresos-anno', YEAR)
            ]);
